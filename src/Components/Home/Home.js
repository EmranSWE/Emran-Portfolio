        ...
        <div>
            <div className="grid lg:grid-cols-3 sm:grid-cols-1 " >
                <div className='p-40 lg:col-span-2'>
                    <p className="text-4xl  ">Hi There!
                        <span className="wave text-4xl" role="img" aria-labelledby="wave">
                            👋🏻
                        </span>
                    </p>
                    <p className="text-5xl font-bold pt-3">I'M <span className="text-5xl font-bold textPrimary">MD EMRAN </span></p>
            ...
            <div class="hero min-h-screen bg-base-200">
                <div class="hero-content flex-col lg:flex-row-reverse">
                    <div class="text-center lg:text-left">
                        <h1 class="text-5xl font-bold">Send message now!</h1>
